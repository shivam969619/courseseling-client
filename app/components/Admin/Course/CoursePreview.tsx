...
const CoursePreview: FC<Props> = ({
  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5 ml-2">
      <div className="w-full relative mr-2">
        ...
        <div className="flex items-center">
          <input
            ...
            className={`${styles.input} 1500:!w-[50%] 1100px:w-[60%] ml-3 !mt-0`}
          />
          <div
        ...
        <p className="pb-1 dark:text-white ">Promise Support</p>
      </div>
      ...
      {courseData?.bemefits?.map((item: any, index: number) => (
